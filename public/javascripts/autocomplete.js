...
AutoComplete.prototype = { // {{{
	...
	if (typeof(MAU) != 'undefined') {
	    AutoComplete.prototype.log = MAU.log;
	} else {
	    AutoComplete.prototype.log = function() {}; 
	}
    ...
    getSuggestions: function(val) { // {{{
  	...
  	// comma starts a new search and val is converted to the new value after the comma
    ...
    doAjaxRequest: function (input) { // {{{
 	...
 	if(this.sInp.length < this.options.minchars) {
	    return false;
	}
  	// create ajax request
    ...
    clearSuggestions:	function (remove) { // {{{
