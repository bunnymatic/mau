...
n)},isElement:function(n){return!!(n&&n.nodeType==1)},isArray:c,isHash:function(n){return n instanceof Hash},isFunction:function(n){return f.call(n)==="[object Function]"},isString:function(n){return f.call(n)===h},isNumber:function(n){return f.call(n)===E},isDate:function(n){return f.call(n)==="[object Date]"},isUndefined:e})})();
...
(function(a){var b=function(){try{var g=document.createElement('<input name="x">');return g.tagName.toLowerCase()==="input"&&g.name==="x"}catch(l){return false}}(),d=a.Element;a.Element=function(g,l){l=l||{};g=g.toLowerCase();var j=Element.cache;if(b&&l.name){g="<"+g+' name="'+l.name+'">';delete l.name;return Element.writeAttribute(document.createElement(g),l)}j[g]||(j[g]=Element.extend(document.createElement(g)));j=(g==="select"?false:"type"in l?false:true)?j[g].cloneNode(false):document.createElement(g);
return Element.writeAttribute(j,l)};Object.extend(a.Element,d||{});if(d)a.Element.prototype=d.prototype})(this);Element.idCounter=1;Element.cache={};Element._purgeElement=function(a){var b=a._prototypeUID;if(b){Element.stopObserving(a);a._prototypeUID=void 0;delete Element.Storage[b]}};
