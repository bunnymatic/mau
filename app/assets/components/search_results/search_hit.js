...
(function() {
  angular.module("mau.models").factory("SearchHit", ngInject(function(objectRoutingService) {
    var SearchHit;
    return SearchHit = (function() {
      function SearchHit(hit) {
        ...
        switch (this.type) {
          case 'artist':
            ...
            if (obj.bio != null) {
              this.description = MAU.Utils.ellipsize(obj.bio);
            }
          ...
          case 'studio':
            ...
            break;
          case 'art_piece':
            this.name = obj.title + (" <span class='byline-conjunction'>by</span> <span class='artist-name'>" + obj.artist_name + "</span>");
