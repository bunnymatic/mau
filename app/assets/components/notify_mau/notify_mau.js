...
(function() {
  var controller, modalController, notifyMau;
  ...
  modalController = ngInject(function($scope, $element, notificationService) {
    return $scope.submitInquiry = function() {
      ...
      success = function(data, status, headers, config) {
        ...
        flash.clear();
        return flash.show({
          notice: "Thanks for your inquiry.  We'll get back to you as soon as we can."
        });
      };
      error = function(data, status, headers, config) {
        ...
        return angular.element(inputs).prepend("<div class='error-msg'>" + (errs.join("")) + "</div>");
      };
  ...
  controller = ngInject(function($scope, $attrs, $element, ngDialog) {
    ...
    switch ($scope.noteType) {
      case 'inquiry':
        $scope.message = "We love to hear from you.  Please let us know your thoughts, questions, rants." + " We'll do our best to respond in a timely manner.";
        return $scope.questionLabel = "Your Question";
      case 'help':
        $scope.message = "Ack.  So sorry you're having issues.  Our developers are only human." + " You may have found a bug in our system.  Please tell us what you were doing and what wasn't working." + " We'll do our best to fix the issue and get you rolling as soon as we can.";
        return $scope.questionLabel = "What went wrong?  What doesn't work?";
    }
  });

  notifyMau = ngInject(function() {
    return {
      restrict: 'E',
