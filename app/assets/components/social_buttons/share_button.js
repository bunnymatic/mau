...
(function() {
  ...
  controller = ngInject(function($scope, $attrs, $location) {
    ...
    $scope.description = function() {
      return "Check out " + $scope.artPiece.title + " by " + $scope.artPiece.artist_name + " on Mission Artists";
    };
    $scope.facebookLink = function() {
      var safeUrl;
      safeUrl = encodeURIComponent($scope.artPieceLink());
      return "https://www.facebook.com/sharer/sharer.php?" + util.hashToQueryString({
        u: safeUrl
      });
    };
    $scope.twitterLink = function() {
      ...
      return "http://twitter.com/intent/tweet?" + util.hashToQueryString({
        text: safeDesc,
        via: 'sfmau',
        url: artPieceUrl
      });
    ...
    $scope.pinterestLink = function() {
      ...
      return "https://pinterest.com/pin/create/button/?" + util.hashToQueryString({
        url: artPieceUrl,
        media: artPieceImage,
        title: title,
        description: desc
