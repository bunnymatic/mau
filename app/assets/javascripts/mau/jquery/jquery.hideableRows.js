...
(function() {
  ...
  jQuery.fn.hideableRows = function(method) {
    ...
    getCheckedClasses = function(container, opts) {
      return _.compact(_.map(jQuery(container).find(opts.whatToHideSelectors), function(item) {
    ...
    toggleItems = function(container, opts) {
      ...
      return jQuery(that).find(opts.row).each(function(idx, row) {
        var $row, hide;
        $row = jQuery(row);
    ...
    methods = {
      init: function(options) {
        ...
        return jQuery(this).on('click', o.whatToHideSelectors, (function(_this) {
          return function(ev) {
    ...
    return this.each(function() {
      if (methods[method]) {
        ...
        return $.error('Method ' + method + ' does not exist on jQuery.hideableRows');
      }
    });
  };
