  ...
  $(function() {
    ...
    navHelpers = {
      ...
      setActiveSection: function() {
        ...
        return $('.nav a[href="' + path + location.search + '"]').closest('.tab').addClass('active');
      }
    };
    ...
    $('.sidenav .tab-content').not('a').on('click', function(ev) {
    ...
    $('.nav .js-nav-mobile, .tab-content .js-close').on('click', function(ev) {
      ev.preventDefault();
      ev.stopPropagation();
      return $(this).closest('.nav').find('.tab-content, .tab-pane').toggleClass('active');
    });
