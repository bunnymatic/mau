...
Barista.configure do |c|
  ...
  c.root = Rails.root.join("app", "assets/coffeescript")

  c.output_root = Rails.root.join("public", "javascripts", "mau")

  # set auto compile for test & dev:   use generated file directly:
  c.each_framework do |framework|
    puts "AutoCompile JS for #{framework}"
    c.register framework, :auto_compile => true
  end
