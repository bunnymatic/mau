Mau::Application.configure do
  ...
  config.assets.precompile += %w( mau-ie.css mau-ie7.css jquery.mobile-1.3.0.min.css thirdparty/excanvas.compiled.js gmaps_google.js mau/mau_gmap.js thirdparty/autocomplete.min.js mau/query_string_parser.js mau_mobile.js mau-mobile.css catalog.css )
