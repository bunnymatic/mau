...
Rails.application.configure do
  ...
  asset_host = ENV["ASSET_HOST"] || ::Conf.ASSET_HOST
  config.action_controller.asset_host = asset_host if asset_host.present?
  ...
  # config.active_job.queue_name_prefix = "mau_#{Rails.env}"
