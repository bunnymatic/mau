import { Arr, Assign, Block, Bool, Call, Class, Code, Comment, Existence, Expansion, Extends, For, If, In, Literal, Null, Obj, Op, Param, Parens, Range, Return, Splat, Switch, Throw, Try, Undefined, Value, While } from 'decaffeinate-coffeescript/lib/coffee-script/nodes';
...
export default function mapAny(context, node) {
    ...
    if (node instanceof Comment) {
        throw new UnsupportedNodeError(node, 'Expected comment notes to be filtered out by mapBlock rather than processed directly.');
    }
