...
export default function formatCoffeeScriptAst(context) {
    var resultLines = formatAstNodeLines(context.coffeeAST, context);
...
function formatAstNodeLines(node, context) {
                    ...
                    for (var value_1 = tslib_1.__values(value), value_1_1 = value_1.next(); !value_1_1.done; value_1_1 = value_1.next()) {
                        ...
                        if (Array.isArray(child)) {
                            ...
                            try {
                                ...
                                try {
                                    if (child_1_1 && !child_1_1.done && (_f = child_1.return)) _f.call(child_1);
                                }
    ...
    var e_1, _c, e_4, _h, e_3, _g, e_2, _f;
}
