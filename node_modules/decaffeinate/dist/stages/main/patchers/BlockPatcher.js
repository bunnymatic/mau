...
var BlockPatcher = (function (_super) {
     ...
     */
    BlockPatcher.prototype.markForPatcherDescendant = function (forPatcher) {
    ...
    BlockPatcher.prototype.initialize = function () {
        try {
            for (var _a = tslib_1.__values(this._forPatcherDescendants), _b = _a.next(); !_b.done; _b = _a.next()) {
                var forPatcher = _b.value;
                try {
                    for (var _c = tslib_1.__values(forPatcher.getIIFEAssignments()), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var name = _d.value;
                        if (countVariableUsages_1.default(this.node, name) > countVariableUsages_1.default(forPatcher.node, name) &&
    ...
    BlockPatcher.prototype.patchInnerStatement = function (statement) {
        var hasImplicitReturn = (statement.implicitlyReturns() &&
        ...
        var implicitReturnPatcher = hasImplicitReturn ?
    ...
    BlockPatcher.prototype.removeFinalEmptyReturn = function (statement) {
        ...
        if (previousToken && previousToken.type === coffee_lex_1.SourceType.NEWLINE &&
