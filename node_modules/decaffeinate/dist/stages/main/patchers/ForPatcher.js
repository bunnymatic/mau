...
var ForPatcher = (function (_super) {
    ...
    ForPatcher.prototype.getEnclosingScopeBlock = function () {
        var patcher = this;
        while (patcher) {
            if (patcher instanceof BlockPatcher_1.default &&
                notNull_1.default(patcher.parent).node === this.getScope().containerNode) {
                return patcher;
            }
    ...
    ForPatcher.prototype.getRelationToken = function () {
        var tokenIndex = this.indexOfSourceTokenBetweenPatchersMatching(notNull_1.default(this.keyAssignee || this.valAssignee), this.target, function (token) { return token.type === coffee_lex_1.SourceType.RELATION; });
        if (!tokenIndex) {
    ...
    ForPatcher.prototype.computeIndexBinding = function () {
        ...
        if (keyAssignee) {
            if (!(keyAssignee instanceof IdentifierPatcher_1.default)) {
