...
var InterpolatedPatcher = (function (_super) {
    ...
    InterpolatedPatcher.prototype.initialize = function () {
        try {
            for (var _a = tslib_1.__values(this.expressions), _b = _a.next(); !_b.done; _b = _a.next()) {
                var expression = _b.value;
                if (expression) {
    ...
    InterpolatedPatcher.prototype.processContents = function () {
        try {
            for (var _a = tslib_1.__values(this.quasis), _b = _a.next(); !_b.done; _b = _a.next()) {
                var quasi = _b.value;
                var tokens = this.getProgramSourceTokens().slice(quasi.contentStartTokenIndex, notNull(quasi.contentEndTokenIndex.next())).toArray();
                try {
