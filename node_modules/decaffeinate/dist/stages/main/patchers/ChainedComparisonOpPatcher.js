 ...
 */
var ChainedComparisonOpPatcher = (function (_super) {
    ...
    ChainedComparisonOpPatcher.prototype.initialize = function () {
        try {
            for (var _a = tslib_1.__values(this.operands), _b = _a.next(); !_b.done; _b = _a.next()) {
                var operand = _b.value;
    ...
    ChainedComparisonOpPatcher.prototype.patchAsExpression = function (_a) {
        ...
        var addParens = negateEntireExpression ||
        ...
        try {
            for (var _d = tslib_1.__values(this.operands.entries()), _e = _d.next(); !_e.done; _e = _d.next()) {
                var _f = tslib_1.__read(_e.value, 2), i = _f[0], operand = _f[1];
                operand.patch();
        ...
        try {
            ...
            try {
                if (middle_2_1 && !middle_2_1.done && (_h = middle_2.return)) _h.call(middle_2);
            }
