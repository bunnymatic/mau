...
var BlockPatcher = (function (_super) {
    ...
    BlockPatcher.prototype.normalizeBetweenStatements = function (leftStatement, rightStatement) {
        var commaTokenIndex = this.indexOfSourceTokenBetweenPatchersMatching(leftStatement, rightStatement, function (t) { return t.type === coffee_lex_1.SourceType.COMMA; });
        if (!commaTokenIndex) {
            return;
        }
