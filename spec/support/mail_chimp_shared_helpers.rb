shared_examples_for MailChimp do
  let(:subscribe_link) {
    "http://missionartistsunited.us2.list-manage.com/subscribe?u=a10070c7a519efbd75c4136a2&id=3e10b86ccc"
  }
  let(:mail_chimp_list_data) {
    {"data" =>
      [
       { "modules"=>[],
         "name"=>"list2",
         "stats"=> {
           ...
           "group_count"=>0,
           "grouping_count"=>0,
           "open_rate"=>71.641791044776},
         "default_language"=>"en",
         "default_from_name"=>"Mission Artists United",
         "subscribe_url_short"=>"http://eepurl.com/xNvrL",
         "email_type_option"=>false,
         "subscribe_url_long"=> subscribe_link,
         "id"=>"list_id",
         "web_id"=>745369,
         "default_subject"=>"",
         "default_from_email"=>"trish@trishtunney.com",
         "list_rating"=>3.5,
         "visibility"=>"pub",
         "beamer_address"=>"us2-e7188aeb75-35be401f11@inbound.mailchimp.com",
         "use_awesomebar"=>true,
         "date_created"=>"2013-04-05 06:36:50"}],
      "total"=>1}
  }
